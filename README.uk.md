...
- Проза чернеток наразі генерується з російськомовними тілами розділів та англомовним frontmatter (власне налаштування автора); налаштування мови заплановано — див. [Що далі](#що-далі).
...
- **Налаштування мови чернеток скілів.** Проза чернеток наразі відповідає локалі автора (російськомовні тіла, англомовний frontmatter). Налаштування `LITOPYS_SKILLS_LANG` — або просто відповідність мові транскрипту — наступний крок розвитку детектора скілів.
